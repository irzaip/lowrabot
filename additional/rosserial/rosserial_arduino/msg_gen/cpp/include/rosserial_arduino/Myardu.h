/* Auto-generated by genmsg_cpp for file /home/ros/ros_workspace/rosserial/rosserial_arduino/msg/Myardu.msg */
#ifndef ROSSERIAL_ARDUINO_MESSAGE_MYARDU_H
#define ROSSERIAL_ARDUINO_MESSAGE_MYARDU_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
private:
  static const char* __s_getDataType_() { return "rosserial_arduino/Myardu"; }
public:
...
public:
  ...
  typedef boost::shared_ptr< ::rosserial_arduino::Myardu_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rosserial_arduino::Myardu_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct Myardu
typedef  ::rosserial_arduino::Myardu_<std::allocator<void> > Myardu;

typedef boost::shared_ptr< ::rosserial_arduino::Myardu> MyarduPtr;
typedef boost::shared_ptr< ::rosserial_arduino::Myardu const> MyarduConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::rosserial_arduino::Myardu_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::rosserial_arduino::Myardu_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::rosserial_arduino::Myardu_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::rosserial_arduino::Myardu_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::rosserial_arduino::Myardu_<ContainerAllocator> > {
  static const char* value() 
  {
    return "d80b48bb7b9460c12e4ef99c393aa5cb";
  }

  static const char* value(const  ::rosserial_arduino::Myardu_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0xd80b48bb7b9460c1ULL;
  static const uint64_t static_value2 = 0x2e4ef99c393aa5cbULL;
};

template<class ContainerAllocator>
struct DataType< ::rosserial_arduino::Myardu_<ContainerAllocator> > {
  static const char* value() 
  {
    return "rosserial_arduino/Myardu";
  }
...
template<class ContainerAllocator>
struct Definition< ::rosserial_arduino::Myardu_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct IsFixedSize< ::rosserial_arduino::Myardu_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::rosserial_arduino::Myardu_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::rosserial_arduino::Myardu_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::rosserial_arduino::Myardu_<ContainerAllocator> & v) 
  {
    s << indent << "ab_dir: ";
...
#endif // ROSSERIAL_ARDUINO_MESSAGE_MYARDU_H
