...
(cl:defmethod ab_dir-val ((m <Myardu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lowrabot-msg:ab_dir-val is deprecated.  Use lowrabot-msg:ab_dir instead.")
  (ab_dir m))

(cl:ensure-generic-function 'kk_dir-val :lambda-list '(m))
(cl:defmethod kk_dir-val ((m <Myardu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lowrabot-msg:kk_dir-val is deprecated.  Use lowrabot-msg:kk_dir instead.")
  (kk_dir m))

(cl:ensure-generic-function 'ab_val-val :lambda-list '(m))
(cl:defmethod ab_val-val ((m <Myardu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lowrabot-msg:ab_val-val is deprecated.  Use lowrabot-msg:ab_val instead.")
  (ab_val m))

(cl:ensure-generic-function 'kk_val-val :lambda-list '(m))
(cl:defmethod kk_val-val ((m <Myardu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lowrabot-msg:kk_val-val is deprecated.  Use lowrabot-msg:kk_val instead.")
  (kk_val m))
